  ...
  head: () => ({
    meta: [
      { title: "Why Bestline | Relationship-Based Business Funding" },
      {
        name: "description",
        content:
          "Why business owners and partners choose Bestline: fast capital, multiple products, cash-flow based options and long-term support.",
      },
...
const cards = [
  ...
  },
  {
    ...
    text: "Bestline offers access to several business funding solutions, from revenue-based financing to SBA loans, lines of credit, term loans, and more.",
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    text: "Certain funding programs may not require real estate or hard collateral, depending on the business profile and product selected.",
  },
  {
    icon: Handshake,
  ...
  },
  {
    ...
    text: "We help business owners understand what lenders and funding partners look for so they can work toward stronger future options.",
  },
];
        ...
        <div className="container-page">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 text-3xl md:text-4xl font-bold text-foreground">
              Funding Solutions for Many Industries
            </h2>
            <p className="mt-4 text-muted-foreground">
              Bestline works with businesses across broad industry coverage and helps match funding
              options based on revenue, time in business, cash flow, and overall business profile.
            </p>
          </div>
          <div className="mt-10 grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {industries.map((ind) => (
              <div
                key={ind}
                className="rounded-lg border border-border bg-background px-4 py-4 text-sm font-medium text-foreground"
              >
                {ind}
              </div>
            ))}
