...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | Bestline Business Funding" },
      { name: "description", content: "Bestline Business Funding privacy policy." },
    ],
  }),
  component: Privacy,
});
  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle="This page is maintained by Bestline Business Funding to answer common security and privacy questions about our services."
      />
      <section className="py-16 bg-background">
        <div className="container-page max-w-3xl text-foreground/85 space-y-6 leading-relaxed">
          <h2 className="text-2xl font-bold text-foreground">
            Web Security/Internet Privacy Policy
          </h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8">
            Bestline Business Funding Privacy Policy
          </h2>
          <p>
            Bestline Business Funding (the “Company”) is committed to maintaining robust privacy
            ...
            assist you in making informed decisions when using our Service. For purposes of this
            Agreement, “Service” refers to the Company’s service which can be accessed via our
            website at www.bestlinefunding.com in which users can review information related to
            alternative funding. The terms “we,” “us,” and “our” refer to the Company. “You” refers
            to you, as a user of Service. By accepting our Privacy Policy, you consent to our
            collection, storage, use and disclosure of your personal information as described in
            this Privacy Policy.
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-6">Information We Collect</h3>
          <p>
            ...
            includes only your name, email address, phone number, business name or other details
          ...
          <p>
            To activate the Service you do not need to submit any Personal Information other than
            your name, email address, phone number, business name or other details. To use the
            Service thereafter, you do not need to submit further Personal Information. However, in
            an effort to improve the quality of the Service, we track information provided to us by
            your browser or by our software application when you view or use the Service, such as
            the website you came from (known as the “referring URL”), the type of browser you use,
            the device from which you connected to the Service, the time and date of access, and
            other information that does not personally identify you. We track this information using
            cookies, or small text files which include an anonymous unique identifier. Cookies are
            sent to a user’s browser from our servers and are stored on the user’s computer hard
            drive. Sending a cookie to a user’s browser enables us to collect Non-Personal
            information about that user and keep a record of the user’s preferences when utilizing
            our services, both on an individual and aggregate basis.
          </p>
          <p>
            For example, the Company may use cookies to collect the following information: Compile
          ...
          <p>
            ...
            questions, solicit feedback from users, provide technical support, and inform users
          ...
          <h3 className="text-xl font-semibold text-foreground mt-6">How We Protect Information</h3>
          <p>
            We implement security measures designed to protect your information from unauthorized
            access. We further protect your information from potential security breaches by
          ...
          <p>
            ...
            promotional e-mail. Please note that notwithstanding the promotional preferences you
            indicate by unsubscribing, we may continue to send you administrative emails including,
            for example, periodic updates to our Privacy Policy.
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-6">Links to Other Websites</h3>
          <p>
            As part of the Service, we may provide links to or compatibility with other websites or
            applications. However, we are not responsible for the privacy practices employed by
            those websites or the information or content they contain. This Privacy Policy applies
            solely to information collected by us through the Site and the Service. Therefore, this
            Privacy Policy does not apply to your use of a third party website accessed by selecting
            a link on our Site or via our Service. To the extent that you access or use the Service
            through or on another website or application, then the privacy policy of that other
            website or application will apply to your access or use of that site or application. We
            encourage our users to read the privacy statements of other websites before proceeding
            to use them.
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-6">Opting Out</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-6">
            Mobile Information and SMS Consent Policy
          </h3>
          <p>
          ...
          <p>
            By submitting your personal contact and/or financial information through the Website,
            you hereby grant express written permission to the Company, its affiliated sites, and
            its business partners for contact via telephone, voice broadcasts, mail, SMS text
            message (data rates may apply), and/or e-mail. Further, by registering on the Website
            you are expressly consenting to receive phone calls from the Company, its affiliated
            sites, and its business partners for contact via telephone and to receive prerecorded
            messages and/or receive calls via automated means even if you are on a Company, state or
            federal Do Not Call List. You may request to receive information via an alternative
            means by contacting the Company, however, if you resubmit your telephone/mobile phone
            number, such request removes any prior alternative means of contact.
          </p>
