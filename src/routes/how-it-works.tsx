  ...
  head: () => ({
    meta: [
      { title: "How It Works | Bestline Business Funding" },
      {
        name: "description",
        content:
          "A simple 4-step business funding process: apply, upload documents, review options, and get funded.",
      },
      { property: "og:title", content: "How Bestline Funding Works" },
      {
        property: "og:description",
        content: "Apply, upload documents, review options, get funded.",
      },
    ],
  }),
...
const steps = [
  {
    ...
    text: "Complete a simple business funding request form with key information about your company.",
  },
  {
    icon: Upload,
    title: "Upload Documents",
    text: "Provide recent business bank statements and other items that may be required for review.",
  },
  {
    icon: Search,
    title: "Review Options",
    text: "Our team reviews your business profile and presents available funding options for your situation.",
  },
  {
    icon: Banknote,
    title: "Get Funded",
    text: "Once approved and completed, funding can move quickly depending on the product and business profile.",
  },
];
      ...
      <section className="py-16 bg-background">
        ...
        <div className="container-page mt-14 rounded-2xl bg-gradient-hero p-10 md:p-12 text-center text-primary-foreground">
          ...
          <p className="mt-2 text-primary-foreground/85">
            Get a funding review tailored to your business in minutes.
          </p>
          <Link
            to="/contact"
